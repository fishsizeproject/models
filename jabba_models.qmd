...
lt: [**Here**](scripts/jabba.Rmd) is an example code of how we used JABBA for modeling five species in the Curonian Lagoon and Kaunas water reservoir (Lithuania). 
...
lt:To learn more about surplus production modeling to Curonian Lagoon and Kaunas Water Reservoir fish stocks and results that could be of interest to managers, you can read [this](resources/KM_jabba_rez.pdf) and [this](resources/Kaunas_jabba_rez.pdf) summary or watch [**this conference talk**](youtube%20link).
