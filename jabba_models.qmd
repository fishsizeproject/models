...
JABBA naudoja sugavimų (laimikių) bei santykinio gausumo laiko eilutę, taip pat reikalinga pirminė informacija apie: a) populiacijos augimo greitį r, b) aplinkos talpą K ir c) biomasės lygį laiko eilutės pradžioje.

Visą informaciją galite rasti kūrėjų puslapyje \[**vignette**\]
:::
...
[Čia](scripts/JabbaModel_example.Rmd) galite rasti pavyzdį, kaip JABBA naudojama žuvų populiacijoms iš Kuršių marių modeliuoti.
:::
