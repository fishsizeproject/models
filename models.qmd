...
::: {.content-visible when-profile="lithuanian"}
::: g-col-8
[1. LT TEXT: Generalized linear model (GLM) based standardisation](GLM_standardisation.qmd) 
<br> 
LT TEXT: This model could be used for scientific monitoring or commercial catch data and applies GLM with Tweedie distribution to extract annual CPUE residuals. Here we apply the model for five common Lithuanian freshwater species.
:::
:::
...
::: {.content-visible when-profile="lithuanian"}
::: g-col-8
[2. LT TEXT: Zero inflated models for CPUE standardisation](Zero_inflated_model.qmd) 
<br>
LT TEXT: If catch data has a lot of zero values, one can also GLMs with adjustments for zero inflation.
:::
:::
...
::: {.content-visible when-profile="lithuanian"}
::: g-col-8
[3. LT: Bayesian model with INLA](Bayesian_inla.qmd)
<br> 
LT: This is a Bayesian model that account for autocorrelation in catches across time and space. It uses approximate Bayesian inference implemented in the [INLA package](https://www.r-inla.org/).
:::
:::
...
LT: Surplus production (SP) models are commonly used to assess data-poor fish stocks and are based on time series of catches and population abundance index (such as standardised CPUE time series, from the models above). These models assume that fish population abundance depends on its regeneration rate, carrying capacity and catches. SP models have been successfully applied to many stocks and, despite their simple assumptions, often perform surprisingly well, assuming the population abundance and catch time series are reliable.
:::
...
<br> 
This little model lets you explore key assumptions behind surplus production population models. 
See how sustainable yield will depend on population regeneration and fishing mortality rate. 
See how catching more fish sometimes can give you less long term yield.
:::
:::
::: {.content-visible when-profile="lithuanian"}
::: g-col-8
[4. LT: Understand SP models](surplus-production.qmd) 
<br> 
LT: This little model lets you explore key assumptions behind surplus production population models. 
See how sustainable yield will depend on population regeneration and fishing mortality rate. 
See how catching more fish sometimes can give you less long term yield.
:::
:::
