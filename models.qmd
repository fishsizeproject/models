...
::: g-col-8
[2. LT: Zero inflated models for CPUE standardisation](Zero_inflated_model.qmd) 
<br> 
LT: If catch data has a lot of zero values, one can also GLMs with adjustments for zero inflation.
:::
...
::: g-col-8
[13. LT: Satellite based chlorophyll A data](satelite_chla.qmd) <br> 
LT: This tool will help you extract chlorophyll A data from satellite observations and apply a model to filter out unreliable data and estimate lake class.
:::
:::
