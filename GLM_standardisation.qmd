...
## LT lang: Introduction

LT lang:Before proceeding with CPUE standardisation, first make sure you carefully **assess and explore your data**. We have prepared the courses and scripts for data exploration, which you can find on our [CPUE standardisation course](https://fishsizeproject.github.io/CPUEcourse/) webpage.
...
You can also watch [**this conference talk**](broken%20link) to learn more about this analysis.
...
::: {.content-visible when-profile="lithuanian"}
## LT lang:Application of the model

LT lang:To learn more about the application of this CPUE standardisation model to Kaunas Water Reservoir fish populations, you can read our [**publication**](https://www.mdpi.com/2410-3888/7/5/232) in journal *Fishes*.
