...
![](images/sizeBasedModels.jpg){width="50%" fig-align="center"} 
<!-- next para ------------------------------------------------------------- -->
...
To make the model calibration easier we have also adapted a ShinyR application available through [mizerExperimental branch](https://github.com/sizespectrum/mizerExperimental). [*Here*](resources/mizerMR_screenshots.pdf) you have a quick look at the application screenshots without having to run it. 

All model code for the Baltic Sea model and all generated data are available on [*GitHub*](https://github.com/maxlindmark/mizer-rewiring/tree/rewire-temp) and on [*Zenodo*](https://doi.org/10.5281/zenodo.6821926).

[Left: Changes in species biomass through time under new fishing scenarios]{.aside}
[Right: Changes in species sizes structure under new fishing scenarios]{.aside}
:::
...
[Kairėje: Kuršių marių rūšių biomasės pokytis pakeitus žvejybos mirtingumą]{.aside}
[Right: Kuršių marių žuvų dydžio struktūros pokytis]{.aside}
:::
...
::: g-col-7
![](images/CuronianLagoonSizeStructure.png){width="100%" fig-align="center"}
:::
:::
...
[Catfish drawing by Amy Rose Coghlan]{.aside} ![](images/vendace.png){width="60%" fig-align="center"}
...
[Šamas Piešinio autorė Amy Rose Coghlan]{.aside} ![](images/vendace.png){width="60%" fig-align="center"}

:::

![](images/Sirulusglanis_sm.png){width="75%" fig-align="center"}
