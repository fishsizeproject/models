...
When you open the Google Colab notebook, **make a copy** of it in your own Google Drive (Select **File** and then **Make a copy in Drive**). You can edit your copy of the notebook, if you need, but don't forget to save. Further instructions on how to use the notebook are found in the notebook itself. To extract surface temperature data you will need to upload a file with codes, names and coordinates of you sites, like in this [**example file**](resources/coord.csv). The dowloaded satellite data will look like this [**example file**](resources/lst_2sites.csv). In this example we only use two data points, but you can add as many data points (rows) as you need. 
...
![](images/lakeTempCorr_EN.png){width="50%" fig-align="center"} 
![](images/lakeTempCorrCoef.png){width="50%" fig-align="center"} 
...
![](images/lakeTempCorr_LT.png){width="50%" fig-align="center"} 
![](images/lakeTempCorrCoef.png){width="50%" fig-align="center"} 
